...
/**
  ...
  * of events. The interval can be given either as [[scala.concurrent.duration.FiniteDuration]] or as a function that will return [[scala.concurrent.duration.FiniteDuration]]
