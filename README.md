...
**sbt**:
```sbt
  libraryDependencies += "io.github.makingthematrix" %% "signals3" % "1.2.1"
```
...
**Mill**:
```
ivy"io.github.makingthematrix::signals3:1.2.1"
```

**Gradle**:
```
compile group: 'io.github.makingthematrix', name: 'signals3_3', version: '1.2.1'
```
